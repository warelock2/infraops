...
- **Proxmox API token**: Regenerate in Proxmox UI → Datacenter → Permissions → API Tokens, then update `secret/infraops/proxmox` and optionally `PROXMOX_API_TOKEN` Forgejo secret.
